lo = function(rown, coln, nrow, ncol, cellheight = NA, cellwidth = NA, treeheight_col, treeheight_row, legend, annotation_row, annotation_col, annotation_colors, annotation_legend, annotation_names_row, annotation_names_col, main, fontsize, fontsize_row, fontsize_col, gaps_row, gaps_col, ...){
    ...
    if(is.na(main)){
        ...
        main_height = unit(1.0, "grobheight", textGrob(main, gp = gpar(fontsize = 1.0 * fontsize, ...)))
    }
...
draw_main = function(text, ...){
    res = textGrob(text, gp = gpar(fontface = "plain", ...))
...
heatmap_motor = function(matrix, border_color, cellwidth, cellheight, tree_col, tree_row, treeheight_col, treeheight_row, filename, width, height, breaks, color, legend, annotation_row, annotation_col, annotation_colors, annotation_legend, annotation_names_row, annotation_names_col, main, fontsize, fontsize_row, fontsize_col, fmat, fontsize_number, number_color, gaps_col, gaps_row, labels_row, labels_col, rot_row, rot_col, vjust_row, hjust_row, vjust_col, hjust_col, ...){
    ...
    # Draw title
    if(!is.na(main)){
        elem = draw_main(main, fontsize = 1.0 * fontsize, ...)
